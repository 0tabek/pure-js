...
when one of them is a 1. (Hint: you will need CSS to position the second dice, so take a look at the class
code for the first one.)
*/


var scores, roundScore, activePlayer, gamePlaying, input, winningScore, lastDice;
...
function init() {
  ...
  roundScore = 0;
  gamePlaying = true;
  input = document.getElementById('winningScore').value;
  ...
  document.getElementById('current-0').textContent = '0';
  document.getElementById('current-1').textContent = '0';
  document.getElementById('name-0').style.display = 'Player 1';
  document.getElementById('name-1').style.display = 'Player 2';
